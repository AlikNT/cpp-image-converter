...
bool SaveJPEG(const Path& file, const Image& image) {
    ...
    /* Шаг 1: выделяем и инициализируем объект сжатия JPEG */

    cinfo.err = jpeg_std_error(&jerr);
    jpeg_create_compress(&cinfo);

    /* Шаг 2: указываем место назначения данных (например, файл) */
    ...
    /* Шаг 3: устанавливаем параметры для сжатия */
    ...
    /* Шаг 5: Записываем строки сканирования */
